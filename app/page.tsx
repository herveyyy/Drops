...
export default function TerminalInit() {
  return (
    <form
      className="min-h-dvh bg-[#070707] text-white font-mono flex flex-col relative overflow-hidden"
    ...
    >
      ...
      <div className="flex-1 flex flex-col items-center justify-center -mt-10 sm:-mt-20 px-5 sm:px-8">
        <div className="max-w-[760px] w-full flex flex-col gap-8 sm:gap-12">
          ...
          <div className="flex flex-col gap-4 sm:gap-5">
            ...
            <h1 className="text-4xl sm:text-[4.5rem] font-black tracking-tighter text-white uppercase m-0 leading-[1.1] wrap-break-word">
              WELCOME_TO_
          ...
          <div className="flex flex-col gap-2 relative mt-4 sm:mt-8">
            ...
            <div className="relative border-b border-[#222] pb-3 sm:pb-4 flex items-center">
              <input
                ...
                className="w-full bg-transparent text-3xl sm:text-5xl font-bold uppercase tracking-widest text-white placeholder-[#1a1a1a] focus:outline-none"
                required
              />
      ...
      <div className="absolute bottom-0 left-0 w-full p-5 sm:p-8 flex justify-end sm:justify-between items-end pointer-events-none">
        ...
        <div className="relative pointer-events-auto group w-full sm:w-auto">
          ...
          <button
            type="submit"
            className="w-full sm:w-auto bg-white text-black font-bold uppercase text-[12px] sm:text-[13px] tracking-[0.2em] px-8 sm:px-10 py-4 sm:py-5 flex items-center justify-center gap-3 sm:gap-4 hover:bg-[#ccc] transition-colors cursor-pointer outline-none"
          >
            CONTINUE
            <svg
              width="18"
